...
(2,'Prithvi','928 BazaarRoad','Madipakkam','Chennai','Tamilnadu','India','612103',1),
(10,'Prithu','J P Nagar, Bengaluru, Karnataka, India','btm','Chennai','TamilNadu','India','560076',1);
...
(1,'Tender Coconut','piece',NULL,NULL,NULL,'32.00','0.00');
...
insert  into `subscription_plan`(`id`,`plan_name`,`subscription_duration_type`,`subscription_duration_number`,`product_id`,`routine_pattern`,`discount_percentage`) values 
(1,'Employees-Daily','month',1,1,'weekdays',0),
(2,'Family-Daily','month',1,1,'daily',0);
